...
integers = [int(i) for i in almost_numbers]
print(integers)


# TODO: list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
numbers_greater_than_nine = [int(number) for number in integers if number > 9]
...
full_names_longer_than_eleven_characters = [name for name in full_names if len(name)>11]
last_name = [name.split() for name in full_names_longer_than_eleven_characters]
